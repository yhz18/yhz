...
function up() {
  ...
  echo $content
      ...
      ."</form>\n";
  echo "远程上传速度是本地上传的N倍，下面是常用的代码：<br>如无法上传dz2.5uf8.zip，改成：dz2.5uf8part1.zip，dz2.5uf8part2.zip，dz2.5uf8part3.zip这三个文件分别下载<br>日本镜向地址：http://yhz.hp2.jp/wp-admin/+文件名，http://lijuncap.bob.buttobi.net/+文件名<br>云镜向地址：http://girl3.aws.af.cm/+文件名，http://wuxibbs.users.sourceforge.net/+文件名<br><br>远程下载地址:<form action=\"".$adminfile."?op=yupload\" method=\"POST\"><input name=\"url\" size=\"80\" /><input name=\"submit\" value=\"上传\" type=\"submit\" /></form>\n"
    ."以下为备用下载地址：（请手动复制）"
    ."<br>Wordpress：http://blog-longfurong.rhcloud.com/wordpress.zip"   
    ."<br>Dz(U8)(part1,2,3)：http://blog-longfurong.rhcloud.com/dz2.5uf8.zip "

    ."<br>yourphp：http://blog-longfurong.rhcloud.com/Yourphp.zip"
    ."<br>yhzadminer：http://blog-longfurong.rhcloud.com/yhzadminer.zip"
    ."<br>piccms：http://blog-longfurong.rhcloud.com/piccms.zip";
  mainbottom();
}
...
function mainbottom() {
  echo "</table></table>\n"
      ."<table width=100%><tr><td align=right><font class=copyright>PHP在线管理系统去空间广告专用版</font></table>\n"
      ."</table></table><style></body>\n"
      ."</html>\n";
  exit;
}
